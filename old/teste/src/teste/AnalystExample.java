 ...
 * this does not need to be the case. This example shows how to use the Encog
 * Analyst from code. This example will download the needed data from UCI. This
 * example can use either the classic Iris dataset of the forest cover data set.
 * You must provide a working directory for it to use.
 *
...
public class AnalystExample {
    ...
    public static final String IRIS_SOURCE = "iris.data";
    public static final String FOREST_SOURCE = "covtype.data";
