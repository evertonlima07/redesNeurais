...
public class AutoMPGRegressionXOR {
    ...
    public File downloadData(String[] args) throws MalformedURLException {
        ...
        BotUtil.downloadPage(new URL(AutoMPGRegressionXOR.DATA_URL), mpgFile);
    ...
    public void run(String[] args) {
        try {
            ...
            ColumnDefinition columnOP1 = data.defineSourceColumn("OP1", 0, ColumnType.continuous);
            ColumnDefinition columnOP2 = data.defineSourceColumn("OP2", 1, ColumnType.continuous);
            /*
            ...
            */
            ...
            data.defineSingleOutputOthersInput(columnOP1);
    ...
    public static void main(String[] args) {
        AutoMPGRegressionXOR prg = new AutoMPGRegressionXOR();
        prg.run(args);
    }
}
